            ...
            "data": [
                {
                    ...
                    "prompt_content": (
                        v.prompt_content[:200] + "..."
                        if len(v.prompt_content) > 200
                        else v.prompt_content
                    ),
    ...
    try:
        ...
        return {
            ...
            "data": {
                ...
                "test_start_date": (
                    version.test_start_date.isoformat() if version.test_start_date else None
                ),
                "test_end_date": (
                    version.test_end_date.isoformat() if version.test_end_date else None
                ),
...
async def create_version(
    ...
    try:
        ...
        existing = (
            ...
            .filter(PromptVersion.version_code == version.version_code)
            .first()
        )
